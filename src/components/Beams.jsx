...
const MergedPlanes = forwardRef(function MergedPlanes({ material, width, count, height }, ref) {
  ...
  return (
    <mesh ref={mesh} geometry={geometry} material={material} receiveShadow castShadow position={[0, 0, 0]} />
  )
})
...
vec3 getNormal(vec3 pos) {
  ...
  return normalize(cross(tangentZ, tangentX));
        ...
        fragment: {
          '#include ': `float randomNoise = noise(gl_FragCoord.xy);\n gl_FragColor.rgb -= randomNoise / 15. * uNoiseIntensity;`
        },
        material: { fog: true },
        uniforms: {
  ...
  return (
    <div
      className={`beams-container ${className}`}
    ...
    >
      ...
      >
        ...
        <directionalLight position={[10, 10, 10]} intensity={1.2} color={lightColor} castShadow />
        <MergedPlanes material={beamMaterial} width={beamWidth} count={beamNumber} height={beamHeight} />
      </Canvas>
    </div>
  )
}
